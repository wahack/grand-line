...
const cmd = `hardhat deploy --network ${network}  --export  ./forweb/${network}/artifacts.json --tags ${tag}`;

// `npx hardhat deploy --network blast-testnet  --export  ./forweb/blast-testnet/artifacts.json --tags `
